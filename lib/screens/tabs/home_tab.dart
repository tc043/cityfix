...
class _HomeTabState extends State<HomeTab> {
  ...
  Future<int> _fetchReportCount({bool within24Hours = false}) async {
    ...
    if (within24Hours) {
      ...
      query = query.where('created_at', isGreaterThan: past24h.toIso8601String());
    }
  ...
  Future<Map<String, int>> _fetchTrendData(String mode) async {
    ...
    int range = mode == 'monthly' ? 30 : mode == 'yearly' ? 365 : 7;
    ...
    for (var doc in snapshot.docs) {
      final createdAt = DateTime.tryParse(doc['created_at'] ?? '') ?? DateTime.now();
                ...
                FutureBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GestureDetector(
                      ...
                      child: _buildStatCard("Total Reports", count, Icons.report, Colors.red),
                    );
                  },
                ),
                FutureBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GestureDetector(
                      ...
                      child: _buildStatCard("Total Resolved", count, Icons.check_circle, Colors.green),
                    );
                  },
                ),
              ],
                ...
                FutureBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return GestureDetector(
                      ...
                      child: _buildStatCard("Reports (24h)", count, Icons.access_time, Colors.orange),
                    );
                  },
                ),
                FutureBuilder<int>(
                  ...
                  builder: (context, snapshot) {
                    final count = snapshot.data ?? 0;
                    return GestureDetector(
                      onTap: () => _navigateToFiltered(context, 'recent_resolved'),
                      child: _buildStatCard("Resolved (24h)", count, Icons.update, Colors.blue),
                    );
                  },
                ),
              ],
